...
public class Task {
    ...
    private TaskPiriority priority;
    ...
    public Task(UUID id, String title, String description, LocalDateTime dueDate,
                TaskStatus status, TaskPiriority priority, TaskList taskList,
    ...
    public TaskPiriority getPriority() {
        return priority;
    }

    public void setPriority(TaskPiriority priority) {
        this.priority = priority;
    }
